...
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: cursive '>Built By MILLICENT</h4>", unsafe_allow_html = True)
...
st.markdown("<p style = 'text-align: justify'>Telecommunications is the transmission of information over a distance using electronic devices such as telephones, radios, TVs, and computers. It involves the exchange of voice, data, and video signals between users through various mediums, including wired and wireless technologies. Here's an overview of key concepts and components", unsafe_allow_html=True)
